...
const goToPage = () => {
  ...
  return (
    <div className="md:px-16 px-3 pt-10">
      ...
      <div className="h-[350px] bg-white rounded-2xl mt-10 flex gap-4 pr-2">
        ...
        <div className="ml-5 mt-5 ">
          <p className="md:text-3xl text-xl font-bold">{machDetails.name}</p>
          <p className="text-[#00000086] font-bold mt-4">
            {machDetails.education}
          </p>
          <p className="text-[#00000095] font-bold mt-4">Wording at,</p>
          <p className="md:text-2xl text-xl font-bold mt-1">{machDetails.working}</p>
          <div className="border-t-1 border-t-[#00000095] border-dashed mt-5 md:w-full w-[200px]">
            <hr  />
          </div>
          ...
          <div className="border-t-1 border-dashed border-t-[#00000095] mt-5 md:w-full w-[200px]">
            <hr  />
          </div>
          ...
          <div className="flex gap-2 mt-3">
            <p className="font-bold text-[14px] md:text-xl">Consultation Fee:</p>
            <p className="text-blue-500 md:text-[16px] text-[14px]">Taka: <span>{machDetails.fee}</span> <span className="text-[#00000081]">(Including vat)</span> <span className="text-blue-500">Per Consultation</span> </p>
          </div>
        </div>
      ...
      <div className="h-[250px] bg-white rounded-2xl mt-6">
           ...
           <div className="flex justify-between items-center px-10 mt-2">
            ...
            <button className="btn text-[#09982F] bg-[#09982f2e] text-[14px] md:text-[16px] ml-2 rounded-4xl">Doctor Available today</button>
           </div>
           <div className="border-t-1 border-t-[#00000056] border-dashed mt-2 w-full">
            <hr  />
          </div>
           <div className="mt-2 pl-10">
            <button className="btn rounded-3xl h-[25px] text-[#FFA000] bg-[#ffa20032] text-[12px] hidden lg:block">
