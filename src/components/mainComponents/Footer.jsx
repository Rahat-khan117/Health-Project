...
const Footer = () => {
    return (
        <div className='md:h-[350px] h-[500px] bg-[#ffff]  md:flex items-center justify-center pt-6'>
            <div className='flex flex-col gap-5 justify-center md:items-center items-start ml-14'>
               <div className='flex gap-2 items-center justify-center'>
                <img src="https://i.ibb.co.com/GvL0WWTY/logo.png" />
                <p className='font-extrabold text-3xl'>Phudu</p>
               </div>
               <div className='text-[#0f0f0fdc] md:flex md:flex-row  flex flex-col  gap-10 '>
